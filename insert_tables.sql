...
('kangjoji', '강민지', '2022-06-11', 'mj', 'passwd1234', '01012340116', '경기 안산시 단원구 강거래길 10 (대부남동)', 0, 50),
...
('entp_sol', '서솔', '2022-06-13', '솔라시도', 'passwd1234', '01012305670', '서울 강동구 구천면로 284 (천호동, 솔빌딩)', 0, 50),
...
INSERT INTO `REPORT` (`seller_id`,`buyer_id`,`product_title`,`product_category`,`product_price`,`product_like`,`product_date`,`product_img`,`product_img_num`,`product_detail`,`deal_method`,`deal_type`,`deal_flag`) VALUES
